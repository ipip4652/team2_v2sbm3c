...
public class Tool {
    ...
    public static synchronized String unit(long size) {
        ...
        if (size < 1024) { // 1 KB 이하, 1024 byte 미만이면
            ...
            str = (int) (Math.ceil(size / 1024.0 / 1024.0 / 1024.0 / 1024.0 / 1024.0 / 1024.0 / 1024.0)) + " ZB";
        }
    ...
    public static synchronized boolean isAvailable(String file) {
        ...
        if (file != null) { // 문자열이 있다면
            ...
            if (file.endsWith(".jpg") || file.endsWith(".jpeg") || file.endsWith(".png") || file.endsWith(".gif")
                    ...
                    || file.endsWith(".ppt") || file.endsWith(".pptx") || file.endsWith(".mp3")
                    || file.endsWith(".mp4")) {
                sw = true;
    ...
    /**
     * 동시 접속자 다운로드의 충돌 처리 2019-12-06_123020_100
     * 
     * @return
     */
