...
public class Order_payVO {
    /*
     * order_payno NUMBER(10) NOT NULL PRIMARY KEY, MEMBERNO NUMBER(10) NULL , rname
     * VARCHAR2(30) NOT NULL, rtel VARCHAR2(14) NOT NULL, rzipcode VARCHAR2(5) NULL
     * , raddress1 VARCHAR2(80) NOT NULL, raddress2 VARCHAR2(50) NOT NULL, paytype
     * NUMBER(1) DEFAULT 0 NOT NULL, amount NUMBER(10) DEFAULT 0 NOT NULL, rdate
     * DATE NOT NULL,
     */
