...
<DIV class="container">
    <h4>(1/6 단계)</h4>
    <H1>맘에 드는 사진1을 골라주세요!</H1>
    <DIV id='panel' style='display: none; margin: 5px auto; width: 90%;'></DIV>
    <form id='frm' name='frm' action='/tensorflow/recommend_perfume/form2.do' method='GET'>
        <br>
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/recommend_perfume/images/fruit1.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/recommend_perfume/images/flower1.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend_perfume/images/musk1.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
            ...
            <TR>
                <TD class='td_image'>
                    <img id='img4' src="/recommend_perfume/images/vanilla1.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/recommend_perfume/images/spicy1.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img6' src="/recommend_perfume/images/wood1.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
