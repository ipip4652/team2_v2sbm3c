...
<DIV class="container">
    <h4>(4/6 단계)</h4>
    <H1>맘에 드는 사진3을 골라주세요!</H1>
    <DIV id='panel' style='display: none; margin: 10px auto; width: 90%;'></DIV>
    <form id='frm' name='frm' action='/tensorflow/recommend_perfume/form5.do' method='GET'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/recommend_perfume/images/fruit4.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/recommend_perfume/images/flower4.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend_perfume/images/musk4.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
            ...
            <TR>
                <TD class='td_image'>
                    <img id='img4' src="/recommend_perfume/images/vanilla4.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/recommend_perfume/images/spicy4.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img6' src="/recommend_perfume/images/wood4.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
                ...
                <TD class='td_radio'>
                    <input type='radio' name='step4' id='step6' value='6' class='td_radio_select'>
                </TD>
            </TR>
        </TABLE>
        <br>
