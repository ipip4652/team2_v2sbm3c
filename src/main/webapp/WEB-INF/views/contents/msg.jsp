  ...
  <fieldset class='fieldset_basic'>
    <UL>
      <c:choose>
        ...
        <c:when test="${param.code == 'product_success'}"> <%-- Java if --%>
          ...
          <LI class='li_none'>                                                   
            <button type='button' 
                         ...
                         class="btn btn-info">관련 상품 정보 재등록</button>
          </LI>
        </c:when>
        ...
        <c:when test="${param.code == 'create_success'}"> <%-- Java if --%>
          ...
          <LI class='li_none'>
            <button type='button' 
                         onclick="location.href='./product_update.do?cateno=${param.cateno}&categrpno=${param.categrpno }&contentsno=${param.contentsno }'"
                         class="btn btn-info">관련 상품 정보 등록</button>
            <button type='button' 
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='./list_by_cateno_search_paging.do?cateno=${param.cateno}'" class="btn btn-info">목록</button>
